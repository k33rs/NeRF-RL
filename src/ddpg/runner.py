...
class Runner:
    def __init__(
        ...
        self.agent = Agent(self.state_dim, self.action_dim, config)
    ...
    def train(self, batch_idx, with_penalty):
        ...
        for episode in itertools.count(1):
            ...
            ep_value_loss, ep_policy_loss = 0., 0.
            ...
            if time_to_save:
                ...
                fig, ax = show_img(info['img_coords'], fig, ax, write_path=self.save_path, title=f'{log}_coords')
                show_img(info['img'], fig, ax, write_path=self.save_path, title=f'{log}_img')
