# [credits] https://github.com/ghliu/pytorch-ddpg
...
class SequentialMemory(Memory):
    ...
    def sample_and_split(self, batch_size, batch_idxs=None):
        ...
        state0_batch = np.array(state0_batch).squeeze(axis=1)
        state1_batch = np.array(state1_batch).squeeze(axis=1)
    ...
    def reset(self):
        super(SequentialMemory, self).reset()
        self.actions.reset()
        self.rewards.reset()
